...
if client_socket:
        msg = "{\"event\": \"player:join\", \"data\": { \"name\" : \"esp32-playerOne\" } }"
        ...
        while True:
            try: 
                ...
                if board["rightScore"] == 10 :
                    ...
                    data_sent = int(clamp(measure_distance() , 0 , 48))
                    msg = "{ \"event\": \"game:paddle\", \"data\": { \"y\":" + str(data_sent) + " , \"playerName\": \"esp32-playerOne\" } }"
                    print(msg)
                    client_socket.send(msg.encode())
